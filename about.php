                    ...
                    <div class="g-base_content">
                        ...
                        <main class="g-main">
                            <section class="o-page">
                                <header class="m-page_header bg-sand">
                                ...
                                <div class="l-container f-p">
                                    <div class="l-grid l-grid--center">
                                        <div class="l-grid__item m-page_body">
                                            ...
                                            <p>From Michael’s mastery of fear and Nita’s newfound friendships at the
                                                infusion center to Erika’s haircutting party and Ricki’s ‘asshole litmus
                                                test,’ the women and men who welcomed Humanly into their homes showed us
                                                a deeply human perspective.</p>

                                        </div>
                                    </div>
                                </div>
                                <div class="o-page__tout">
                                    <article
                                        ...
                                        <div class="m-share_story__inner bg-image invert-bg">
                                            <div class="l-container">
                                                ...
                                                <div class="m-share_story__cta">
                                                    <a href="http://www.livehumanly.com"
                                                        class="a-btn a-btn--type=secondary"
                                                        data-behavior="AnalyticsClickTracking"
                                                        data-analyticsclicktracking-label="about - learn more"
                                                        target="_blank">
