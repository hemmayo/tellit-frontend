            ...
            <div data-pjax-wrapper="pjax">
                <div data-pjax-container="pjax" data-namespace="main">
                    <div class="g-base_content">
                        <div class="l-container uk-margin">

                            <main class="g-main">
                                <h1 class="uk-margin-bottom f-h3">Stories</h1>
                    ...
                    foreach ($reports as $report) {
                        ...
                        <article class="uk-height-large m-story m-story--audio l-container@small-  bg-green is-visible">
                            ...
                            <div class="m-action_bar is-hidden"
                                                        data-InlineActionsToggle-actions>
                ...
                ?>
                                        <div class="o-feed__item col-md-6" data-behavior="FeedItem">
                                            ...
                                            <article
                                                class="uk-height-large m-story m-story--audio l-container@small-  bg-green is-visible">
                                                <h4 class="f-p m-story__title f-p_sans">
                                                    <a href="?q=Janet ">Janet</a>, on <a href="?tag=Self-care">Bully</a>

                                                </h4>
                                                <div class="l-grid">
                                                    <p class="m-story__body l-grid__item f-p_serif f-p"> Our son Jake
                                                        was
                                                        diagnosed with a rare brain tumor at the age of 2. Jake taught
                                                        us
                                                        that no matter what the circumstance is, we have to live in the
                                                        now.
                                                        Even when the now seems ordinary, and quiet …</p>
                                                </div>
                                                <div class="m-story__cta">
                                                    <button class="a-btn a-btn--type=primary a-btn--with_icon"
                                                        data-behavior="PlayToggleBtn Tooltip"
                                                        data-Tooltip-mouseover="true"
                                                        ...
                                                        <svg class="icon--play-mini a-btn__icon" role="img" title="Play"
                                                            aria-labelledby="icon--play-mini-3"
                                                            data-PlayToggleBtn-playicon>
                                                        ...
                                                        <svg class="icon--pause-mini a-btn__icon" role="img"
                                                            title="Pause" aria-labelledby="icon--pause-mini-2"
                                        ...
                                        <div class="o-feed__item col-md-6" data-behavior="FeedItem">
                                            <article
                                                class="uk-height-large m-story m-story--text l-container@small-  bg-blue"
                                                data-Feed-itemid="442">
                                                <h2 class="m-story__title f-p_sans f-p">
                                                    <a href="?q=Nita ">Nita</a>, on <a href="?tag=Lifestyle">Neglect</a>
                                                </h2>
                                                <div class="l-grid">
                                                    <p class="m-story__body l-grid__item f-p_serif f-p">Just for today,
                                                        laugh
                                                        out loud, sing a song, be assertive, be silly, be happy, be
                                                        strong.
                                                        Just for today do it all once and then if you liked it tomorrow
                                                        do
                                                        it all once again.</p>
                                                </div>
                                                <div class="m-story__cta m-story__cta--inline_actions"
                                                    ...
                                                    <button class="a-btn a-btn--type=secondary a-btn--only_icon"
                                                        ...
                                                        <svg class="icon--kebab-horiz a-btn__icon" role="img"
                                                            title="Tools" aria-labelledby="icon--kebab-horiz-1">
                                                            <use xlink:href="#icon--kebab-horiz"></use>
                                                            <title id="icon--kebab-horiz-1">
                                                                Tools
                                                            </title>
