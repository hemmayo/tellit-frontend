...
<div class="l-grid">
  <div class="l-grid__item o-contact_form o-contact_form--sign-in">
    ...
    <form class="m-form o-contact_form__form" data-behavior="AjaxForm AjaxFormResponses" data-ajaxform-url="https://ourstory.livehumanly.com/signin/signin_process" data-ajaxform-formtype="signin" data-ajaxformresponses-modalname="sign-in-modal" action="/signin" method="post">
    <div class="m-form__section">
                    <div class="m-form__item">
        <label class="a-field">
<input type="text" name="username" value="" class="a-field__input" data-behavior="PopulatedInput" required="">
