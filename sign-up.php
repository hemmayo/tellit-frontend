                ...
                <div data-pjax-container="pjax" data-namespace="main">
                  <div class="g-base_content">
                    ...
                    <div class="l-container">
                      <div class="l-grid l-grid--center">
                        ...
                        <div class="l-grid__item o-contact_form">
                          ...
                          <form class="m-form o-contact_form__create-form" data-behavior="AjaxForm AjaxFormResponses" data-ajaxform-url="registration_process" data-ajaxform-formtype="createprofile1" action="/create_profile2" method="post" enctype="multipart/form-data">

                            <div class="m-form__section  l-grid">
                    		                        <div class="m-form__item m-form__item--text l-grid__item m-form__item--small">
                                <label class="a-field">
                      <input type="text" name="first_name" value="" class="a-field__input" data-behavior="PopulatedInput" required="">
                    ...
                    <span class="desc"></span>        </div>
                                            <div class="m-form__item m-form__item--text l-grid__item m-form__item--small">
                                <label class="a-field">
                      <input type="text" name="last_name" value="" class="a-field__input" data-behavior="PopulatedInput" required="">
                      <div class="a-field__placeholder">
                        Last name
                      </div>
                    </label>
                    <span class="desc"></span>        </div>
                                ...
                                <label class="a-field">
                      <input type="email" name="email" value="" class="a-field__input" data-behavior="PopulatedInput" required="">
                      <div class="a-field__placeholder">
                        Email
                      </div>
                    </label>
                    <span class="desc"></span>        </div>
                                            <div class="m-form__item m-form__item--text l-grid__item m-form__item--large">
                                <label class="a-field">
                      <input type="password" name="password" value="" class="a-field__input" data-behavior="PopulatedInput" required="">
                      <div class="a-field__placeholder">
                        Password
                      </div>
                    </label>
                    <span class="desc"></span>        </div>
                                            <div class="m-form__item m-form__item--text l-grid__item m-form__item--large">
                                <label class="a-field">
                      <input type="password" name="password_confirmation" value="" class="a-field__input" data-behavior="PopulatedInput" required="">
                      <div class="a-field__placeholder">
                        Confirm password
                      </div>
                    </label>
                    <span class="desc"></span>        </div>
                      ...
                      <p class="f-p">Humanly will never share your information outside of this platform. As a member, you can always edit your profile information at any time. Your name, profile photo, biography, submitted content and saved playlists will be available to all visitors — however your personal contact information will not be visible without your consent.</p>
                    </div>
                            </div>
                      ...
                      <div class="f-p untuck a-checkbox__label">
                        You agree to our <a href="https://ourstory.livehumanly.com/content/terms" target="_blank">terms of use</a>
                      </div>
                    </label>
                            </div>
                                </div>
                          ...
                          <p class="m-form__btn"><a href="https://ourstory.livehumanly.com/signin" class="f-p o-contact_form__link">I'm already registered</a></p>
                        </div>
                      </div>
